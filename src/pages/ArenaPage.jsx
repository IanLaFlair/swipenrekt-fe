  ...
  return (
    <>
      ...
      <div style={{ flex: "1", position: "relative", display: "flex", alignItems: "center", justifyContent: "center", padding: "6px 24px 0", minHeight: "0" }}>
        ...
        <div onPointerDown={onPointerDown} onPointerMove={onPointerMove} onPointerUp={onPointerUp} onPointerCancel={onPointerUp} style={{ position: "relative", width: "100%", height: "452px", borderRadius: "28px", overflow: "hidden", background: "linear-gradient(165deg,#1c1c2b 0%,#0f0f18 100%)", border: "1px solid rgba(255,255,255,.1)", boxShadow: "0 26px 64px rgba(0,0,0,.6)", display: "flex", flexDirection: "column", padding: "24px 20px 20px", zIndex: "3", touchAction: "none", cursor: "grab", willChange: "transform", transform: topTransform, transition: topTransition, opacity: topOpacity }}>
